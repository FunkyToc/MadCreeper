execute if score McVersion fktool matches ..11300 run function mc:creepers/nuclear_style_1.13
execute if score McVersion fktool matches 11400.. run function mc:creepers/nuclear_style_1.14
