...
execute if score McVersion fktool matches 113 run function mc:creepers/sneaky_style_1.13
execute if score McVersion fktool matches 114.. run function mc:creepers/sneaky_style_1.14